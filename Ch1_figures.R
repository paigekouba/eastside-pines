...
png("FEM_Fig1.png", width=30, height = 23.5, units = "cm", res = 300)
plot(dotplots) + theme(base_size = 7) # percent change in nonspatial metrics, by site. 1941 in red, 2018 in black, with mean and se
dev.off()

# ICO_maps 
# png("Ch1_Fig2a.png", width=7, height =5.5, units = "in", res = 300)
png("FEM_Fig2a.png", width=30, height = 23.5, units = "cm", res = 300)
...
png("FEM_Fig2b.png", width=30, height = 23.5, units = "cm", res = 300)
...
png("FEM_Fig3.png", width = 30, height = 19, units = "cm", res = 300)
...
# dev.off()
png("FEM_Fig4.png", width=30, height = 10, units = "cm", res = 300)
LydersenFig3
dev.off()

png("FEM_Fig5.png", width=30, height =10, units = "cm", res = 300)
